...
const SELECT =
  'w-full cursor-pointer appearance-none rounded-[12px] border border-[var(--edge)] bg-[var(--well)] px-3 py-2.5 text-[13.5px] text-fg outline-none focus:border-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue'
...
export function LanguagePicker({ speak, hear, onChange }: LanguagePickerProps) {
  return (
    <div className="glass flex w-full gap-2 rounded-[16px] p-3">
