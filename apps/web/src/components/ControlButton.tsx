...
export function ControlButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'grid h-11.5 place-items-center rounded-full border transition-colors focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-blue',
        wide ? 'w-auto gap-2 px-5.5' : 'w-11.5',
        ...
        state === 'default' && 'border-(--edge) bg-(--pane-2) text-fg hover:bg-white/20',
